...
public class MainFrame extends Frame{
    ...
    static DNABrick dnaTile;
    static boolean newTileCreated = false;
    static boolean newProjectCreated = false;
    static boolean saveTileFunctionCalled = false;
    static double tileHeight = 3; // Default Height = 3nm
    static double tileWidth = 7; // Default Width = 7nm
    ...
    static char savedDataType;
    
    //data for optimized sequences
    static int GCrangeFrom=0;
    static int GCRangeTo=0;
    static boolean HighFreeEnergy=false;
    static boolean HighFreeEnergyDigitized=false;
    static int FreeEnergyFrom=0;
    static int FreeEnergyTo=0;
    
    static int[][] selectedFree=new int[100][350];;
    static int[][] selectedDigitized=new int[15][23];
    static int freeTracker=0;
    static int digitizedTracker=0;

    //keeping track of saving sequences
    static boolean isFreeSaved=false;
    static boolean isDigitizedSaved=false;
    ...
    static JButton shapes=new JButton("Draw Shapes");
    ...
    public static void AddContent(){
        ...
        JMenuItem saveShort= new JMenuItem("Save");
        saveShort.setFont(new Font("default",Font.BOLD,13));
        saveShort.setMaximumSize(new Dimension(30,30));
        
        jMenuBar.add(saveShort);       
        ...
        JMenuItem saveRandSeqItem = new JMenuItem("Generate DNA data", new ImageIcon("images/save.png"));
        //JMenuItem saveOptimizedSeqItem = new JMenuItem("Generate Optimized DNA data", new ImageIcon("images/save.png"));
        ...
        JMenuItem renderImage=new JMenuItem("Render Image", new ImageIcon("images/upload.png"));
        JMenuItem Export=new JMenuItem("Export Source File", new ImageIcon("images/export.png"));
        ...
        if(newProjectCreated==false){
            ...
            saveRandSeqItem.setEnabled(false);
            //saveOptimizedSeqItem.setEnabled(false);
        ...
        saveShort.addActionListener(new SaveDrawDataActionListener());
        ...
        shapes.addActionListener(new ShapePanelListener());
        ...
        if (MainFrame.currentWindow == 1) {
            ...
            if (MainFrame.isFreeSaved==false) {
                ...
                if (userChoice == JOptionPane.NO_OPTION) {
                	...
                	System.out.println("cancel confirmed, allowed:"+allowexit);
