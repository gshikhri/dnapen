...
public class ModifyOptimizedSeq{

    static boolean alreadySavedDetailedDNA=false;
    static AssignOptimizedSeq a;
    static ArrayList<Domains> xyDomainListDigital= AssignOptimizedSeq.xyDomainList;
    ...
    public ModifyOptimizedSeq() {
    	a=new AssignOptimizedSeq();
 ...
 //                       }
    ...
    public void ModifyFreeGrid() {
        ...
        ArrayList<Domains> xyDomainListFree= AssignOptimizedSeq.xyDomainListFree;
        int k;
        xyDrawdataListFree.clear();
