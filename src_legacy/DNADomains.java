/* Author: Arnav Goyal, Foram Joshi and Akshita Sahai
 * Project: DNA Pen
...
public class DNADomains {
    ...
    public void generateSeq(int i, int j) {
        ...
        if(j==0){
            if(i==0){
                dnaSequenceGenerator = new DNASequenceGenerator(10,"P");
                ...
                dnaSequenceGenerator = new DNASequenceGenerator(11,"G");
                ...
                dnaSequenceGenerator = new DNASequenceGenerator(11,"P");
                domainSeqTwo = dnaSequenceGenerator.getRandomDNASeq();
    ...
    public boolean checkThermalSecondaryStability() {
        ...
        boolean thermalSeqThree = false;
        boolean thermalSeqFour = false;
        int seqOneLength = domainSeqOne.length();
        int seqTwoLength = domainSeqTwo.length();
        int seqThreeLength = domainSeqThree.length();
        int seqFourLength = domainSeqFour.length();

        thermalSeqOne = checkSeqStability(domainSeqOne, seqOneLength);
        thermalSeqTwo = checkSeqStability(domainSeqTwo, seqTwoLength);
  //      thermalSeqThree = checkSeqStability(domainSeqThree, seqThreeLength);
  //      thermalSeqFour = checkSeqStability(domainSeqFour, seqFourLength);

        thermalPassed = thermalSeqOne&&thermalSeqTwo;
        //&&thermalSeqThree&&thermalSeqFour;
