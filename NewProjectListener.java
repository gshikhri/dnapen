...
public class NewProjectListener implements ActionListener {
    ...
    JFrame TileDimInputFrame;
    JTextField inputname;
    JTextField pathname;
    public void showInputDialogue() {
        MainFrame.framecounter=1;
        TileDimInputFrame = new JFrame("Select a name for your project");
        TileDimInputFrame.setSize(400, 150);
        ...
        TileDimInputFrame.setLayout(new GridLayout(3, 2));
        TileDimInputFrame.add(jLabelDimension);
        ...
        TileDimInputFrame.add(jPanel);
        TileDimInputFrame.add(jPanel1);



        Dimension screenDimensions = Toolkit.getDefaultToolkit().getScreenSize();

        TileDimInputFrame.setLocation(screenDimensions.width/2 - TileDimInputFrame.getSize().width/2,
                screenDimensions.height/2 - TileDimInputFrame.getSize().height/2);

        TileDimInputFrame.setVisible(true);
        ...
        TileDimInputFrame.addWindowListener(exitListener);
...
class SubmitActionListener extends JPanel
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.newTileCreated=false;
        MainFrame.saveTileFunctionCalled=false;

        newcontent.AddContent();
        GenerateDNAFile gen=new GenerateDNAFile();
        gen.SaveToFile();
        System.out.print("Done!");
        TileDimInputFrame.dispose();
        }
        else{
    ...
    class CancelActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            MainFrame.framecounter=0;
            TileDimInputFrame.setVisible(false);
